...
from cbox.build.lib.chatterbot import ChatBot
from cbox.build.lib.chatterbot.trainers import ChatterBotCorpusTrainer
...
class TkinterGUIExample(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.chatbot = ChatBot("Eliza",
                               storage_adapter="cbox.build.lib.chatterbot.adapters.storage.JsonFileStorageAdapter",
